 ...
 * Utilizes MockGeoJSON file to test the QueryHandler class.
 */
public class TestMockQuery {
    ...
    /**
     * Tests the QueryHandler class with a mock GEOJSON file passing in wrong argument nonexisten in area description.
     * @throws IOException
     */
    @Test
    public void testMockWrongArg() throws IOException{
        String data = "";
        try {
            Reader reader = new FileReader("src/main/java/edu/brown/cs32/examples/sprint3/data/mockGEO.json", StandardCharsets.UTF_8);
            BufferedReader bf = new BufferedReader(reader);
        ...
        HttpURLConnection clientConnection = tryRequest("query1?keyword=bhalwani");
    ...
    /**
     * Tests the QueryHandler class with a mock GEOJSON file passing in correct argument existent in area description.
     * also tests the search history.
     * @throws IOException
     */
    @Test
    public void testCorrectArgs() throws IOException{
        ...
        // snuck in my name into the area description
        HttpURLConnection clientConnection = tryRequest("query2?keyword=zeeshan");
    ...
    /*
    * tests the eviction queue
    */
    @Test
    public void testMockEvictionQueue() throws IOException{
        String data = "";
        try {
            Reader reader = new FileReader("src/main/java/edu/brown/cs32/examples/sprint3/data/mockGEO.json", StandardCharsets.UTF_8);
            BufferedReader bf = new BufferedReader(reader);
        ...
        // max gets added to search history
